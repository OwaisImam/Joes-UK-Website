...
else 
{
	...
	if(mysql_num_rows($resource) > 0)
	{
		...
		<div class="alert alert-danger alert-dismissable">
			<i class="fa fa-ban"></i>
			<b>Product is already in your wish list. <a href="wishlist" >Click here</a> to view your wishlist.</b>
		</div>
		</div>
	</section>';
	}
	...
	{
		mysql_query("INSERT INTO wishlist SET ProductID=".$id.", UserID=".$_SESSION["CustomerID"].", DateAdded=NOW()") or die(mysql_error());
		$_SESSION["CartMessage"] = '<section id="msgcart" class="mainnavbar">
		<div class="col-md-12">
		<div class="alert alert-success alert-dismissable">
			<i class="fa fa-check"></i>
			<b>Product added to your <a href="wishlist" >wishlist</a></b>
		</div>
		</div>
	</section>';
	}
