<?php
	...
	{
		$_SETTINGS_Header_LOGO = mysql_result($result, 0, 2);
		$_SETTINGS_Footer_LOGO = mysql_result($result, 1, 2);
	}
	else
		$_SETTINGS_LOGO = mysql_result($result, 0, 2);
	
	$settingResultSet=mysql_query("SELECT * FROM configurations ") or die(mysql_error());
	$settingRecordSet=mysql_fetch_array($settingResultSet);
	...
	{
		$a = mysql_query("SELECT ".$one." FROM ". $two." WHERE ".$three."='".$four."'") or die(mysql_error());
		if(mysql_num_rows($a) > 0)
			return mysql_result($a, 0, 0);
		else
			return '';
	}
	...
	function  total_products()
		...
		function  total_brands()
		{
			...
			$res = mysql_query("SELECT * FROM brands") or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
		...
		$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('107',Categories) AND FIND_IN_SET('125',Categories)") or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
	...
	function  total_pants()
		{
			...
			$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('117',Categories)AND FIND_IN_SET('107',Categories)") or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
		...
		$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('107',Categories) AND FIND_IN_SET('126',Categories) ") or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
		...
		$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('108',Categories) AND  FIND_IN_SET('137',Categories) " ) or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
		...
		$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('107',Categories) AND  FIND_IN_SET('143',Categories) " ) or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
		...
		$res = mysql_query("SELECT * FROM products where Status = 1 AND FIND_IN_SET('108',Categories) AND  FIND_IN_SET('144',Categories) " ) or die(mysql_error());
			$Rs = mysql_fetch_assoc($res);
			$Students = mysql_num_rows($res);
			return $Students;
		}
