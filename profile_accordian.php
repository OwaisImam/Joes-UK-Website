	...
	<div class="contact">
		<div class="container">
        <h3>Welcome Back <span> <?php echo $_SESSION["CustomerFullName"]; ?></span></h3>
				</div>
   <div class="col-md-12">
    <div id="MainMenu" class="accordians">
      <div class="list-group panel">
        <a href="#accountinfo" class="list-group-item list-group-item-info" data-toggle="collapse" data-parent="#MainMenu"><span class="number"><h1><i style="margin-top:4px;" class="fa fa-user"></i></span> Profile Details</h1></a>
		<div class="collapse common <?php if(isset($_SESSION['msg1']) && $_SESSION['msg1']!=''){ echo 'in';} ?>" id="accountinfo">
         <div class="col">
			<?php
		  		echo $msg1;
...
<div class="col-sm-10">
    <select name="Country" id="input-country" class="form-control">
       ...
       <div class="buttons">
        ...
        <span class="number"> <h1><i style="margin-top:4px;" class="fa fa-truck"></i></span> Shipping Information</h1></a>
        <div class="collapse common" id="shippinginfo">
        <?php 
       ...
       <!-- <a href="#orderdetail" class="list-group-item list-group-item-info" data-toggle="collapse" data-parent="#MainMenu"><span class="number"><i style="margin-top:4px;" class="fa fa-shopping-cart"></i></span>Order Details</a>
        <div class="collapse common" id="orderdetail">
		<h1>Order Details</h1>-->
		<!--<div class="row">
			<div class="col-md-12">
				<ul>
					<li><label for="COD"><input type="radio" id="COD" name="paymentType" value="COD" checked>Cash On Delivery</label></li>
					<li><label for="CC"><input type="radio" id="CC" name="paymentType" value="CC">Cradit Card</label></li>
					<li><label for="Paypal"><input type="radio" id="Paypal" name="paymentType" value="Paypal">Paypal</label></li>
				</ul>
			</div>
		...
		<a href="#resetpswd" class="list-group-item list-group-item-info" data-toggle="collapse" data-parent="#MainMenu"><span class="number"></span><h1><i style="margin-top:4px;" class="fa  fa-lock"></i> Reset Password </h1></a>
        <div class="collapse common <?php if(isset($_SESSION['msg2']) && $_SESSION['msg2']!=''){ echo 'in';} ?>" id="resetpswd">
		 <div class="col">
			<?php
		  		echo $msg2;
				echo $msg3;
      ...
      <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data" class="form-horizontal">
       ...
       <div class="buttons">
		...
		<a href="#history" class="list-group-item list-group-item-info" data-toggle="collapse" data-parent="#MainMenu"><span class="number"></span><h1><i style="margin-top:4px;" class="fa  fa-shopping-cart"></i> Order History </h1></a>
        <div class="collapse common <?php if(isset($_SESSION['msg2']) && $_SESSION['msg2']!=''){ echo 'in';} ?>" id="history">
		 <div class="col">
    <div class="row">
        <div class="col-sm-3">
		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					...
					<td class="text-left"><?php echo CURRENCY_SYMBOL; ?><h3 class="title"><?php echo round($subtotal+$optiontotal+$shippingAmount); ?></h3></td>
				</tr>
			</tbody>
		</table>
		</div>
