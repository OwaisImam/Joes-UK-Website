	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Search result for <?php echo $Keyword; ?></li>
			</ol>
		</div>
	</div>
	<!--//breadcrumbs-->
...
<?php
                    ...
                    <form id="frmsubmit" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
			...
			<div class="col-md-9 product-model-sec">
                    <div class="sortby">
                       ...
                       <select id="input-sort" id="sorting" name="sort" onchange='this.form.submit()'>
						...
						<h3 class="title">Search result for <?php echo $Keyword; ?></h3>
                    </div>
					</form>
					<br/><br/>
					<?php
					$per_page = 24;
					$query="SELECT ID,ProductName,ProductNameArabic,Image,Price,Discount,URL,Ratings FROM products WHERE Status = 1 AND ProductName LIKE '%".dbinput($Keyword)."%'";
					...
					?>	
				<div class="col-md-4 product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="<?php echo $URLTemp; ?>"><img src="<?php echo 'admin/'.DIR_PRODUCTS_IMAGES.$img1 ?>" class="img-responsive" alt="<?php echo $ProductNameTemp; ?>"/></a>
						<div class="new-text">
							<ul>
								<li><a href="<?php echo $URLTemp; ?>">View Product</a></li>
								<li><input type="number" class="item_quantity" min="1" value="1" id="Quantity<?php echo $ID; ?>"></li>
								<li><a class="item_add cursor-pointer" onclick="window.location.href='add_to_cart.php?id=<?php echo $ProductIDTemp; ?>&name=<?php echo $ProductNameTemp; ?>&quantity='+$('#Quantity<?php echo $ID; ?>').val()+'&upsell=2&options=0&url=<?php echo $_SERVER['REQUEST_URI']; ?>'"> Add to cart</a></li>
							</ul>
						</div>
					</div>
					<div class="new-bottom">
						<h5><a class="name" href="<?php echo $URLTemp; ?>"><?php echo substr($ProductNameTemp, 0, 20).(strlen($ProductNameTemp) > 20 ? ' ...' : ''); ?></a></h5>
						<div class="rating">
							<?php
							for($iiii = 0; $iiii < 5;  $iiii++)
							{
								if($iiii <= ($Ratings*0.05))
						...
						<div class="ofr">
									...
									$Price = $PriceTemp;
									echo ($Discount != 0 ? '<p><span class="item_price">'.CURRENCY_SYMBOL.$Discount.'</span></p><p class="pric1"><del>'.CURRENCY_SYMBOL.$Price.'</del></p>' : '<p><span class="item_price">'.CURRENCY_SYMBOL.$Price.'</span></p>');
